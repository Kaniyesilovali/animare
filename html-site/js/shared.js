...
<header class="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-[var(--color-border)] shadow-sm">
  <div class="mx-auto max-w-6xl px-4 sm:px-6">
    <div class="flex h-16 items-center justify-between">
      <a href="/${lang}/"><img src="/animare_veteriner_logo.png" alt="Animare Veteriner" class="h-16 w-auto object-contain" style="max-height:64px"></a>
      ...
      <div class="hidden md:flex items-center gap-3">
        <div class="flex items-center gap-1 text-sm font-medium">
          <span class="${isTr ? 'text-[var(--color-primary)] font-semibold' : 'text-[var(--color-muted)] hover:text-[var(--color-text)]'}"><a href="/${lang}/">${lang.toUpperCase()}</a></span>
          <span class="text-[var(--color-muted)]">/</span>
          <a href="${otherUrl}" class="${!isTr ? 'text-[var(--color-primary)] font-semibold' : 'text-[var(--color-muted)] hover:text-[var(--color-text)] transition-colors'}">${otherLang.toUpperCase()}</a>
        </div>
    ...
    <div id="mm" class="hidden md:hidden border-t border-[var(--color-border)] py-3 flex flex-col gap-0.5">
      ...
      <div class="pt-2 px-3 flex items-center gap-2 text-sm font-medium">
        <span class="${isTr ? 'text-[var(--color-primary)] font-semibold' : 'text-[var(--color-muted)]'}">TR</span>
        <span class="text-[var(--color-muted)]">/</span>
        <a href="${otherUrl}" class="${!isTr ? 'text-[var(--color-primary)] font-semibold' : 'text-[var(--color-muted)]'}">${otherLang.toUpperCase()}</a>
      </div>
    </div>
  </div>
</header>`;
...
<footer class="bg-[var(--color-text)] text-white">
  <div class="mx-auto max-w-6xl px-4 sm:px-6 py-12">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <div class="mb-4"><img src="/animare_veteriner_logo.png" alt="Animare Veteriner" class="h-12 w-auto object-contain"></div>
