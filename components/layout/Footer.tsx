      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-white/70 leading-relaxed">{dict.footer.desc}</p>
            <div className="flex gap-3 mt-4">
              <a
                href="https://www.instagram.com/animare.vet/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/animare.vet"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li>{dict.contact.phoneValue}</li>
              <li>{dict.contact.emailValue}</li>
